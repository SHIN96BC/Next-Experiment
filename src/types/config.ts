...
export type PresetColor =
  ...
  | 'theme7'
  | 'theme8';
export type I18n = 'en' | 'ko'; // 'en' - English, 'fr' - French, 'ro' - Romanian, 'zh' - Chinese
...
export type DefaultConfigProps = {
  ...
  /**
   * The props used for display menus-items with multi-language.
  ...
  /**
   * the props used for menus orientation (diffrent theme layout).
